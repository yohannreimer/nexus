...
-- ================================================
-- ATENÇÃO: Este script DROPA e RECRIA todas as tabelas!
-- Execute apenas se você quer começar do zero ou migrar para o novo schema
-- ================================================
...
CREATE INDEX idx_report_logs_user_id ON public.report_logs(user_id);
CREATE INDEX idx_report_logs_client_id ON public.report_logs(client_id);
...
-- Tabelas: profiles, facebook_connections, ad_accounts, clients, message_templates, report_logs, user_settings

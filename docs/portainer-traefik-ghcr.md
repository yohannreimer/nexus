...
O stack do Portainer usa uma tag imutavel de commit, por exemplo `ghcr.io/yohannreimer/nexus:102a2e20269843bd6932c7c9edae809830db5f71`, em vez de `latest`. Isso evita o problema do Swarm/Portainer reaproveitar a imagem antiga quando voce clica em **Update the stack**.
